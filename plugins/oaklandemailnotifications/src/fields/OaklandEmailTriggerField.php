...
namespace meetgoat\oaklandemailnotifications\fields;

use meetgoat\oaklandemailnotifications\OaklandEmailNotifications;
use meetgoat\oaklandemailnotifications\assetbundles\oaklandemailnotificationsfieldfield\OaklandEmailNotificationsFieldFieldAsset;
...
class OaklandEmailTriggerField extends Field
{
    ...
    {
        return Craft::t('oakland-email-notifications', 'Email Triggers');
    }
    ...
    public function getSettingsHtml()
    {
        ...
        return Craft::$app->getView()->renderTemplate(
            'oakland-email-notifications/_components/fields/OaklandEmailTriggerField_settings',
            [
                'field' => $this,
            ]
        );
    ...
    public function getInputHtml($value, ElementInterface $element = null): string
    {
        ...
        Craft::$app->getView()->registerAssetBundle(OaklandEmailNotificationsFieldFieldAsset::class);
        ...
        Craft::$app->getView()->registerJs("$('#{$namespacedId}-field').OaklandEmailNotificationsOaklandEmailNotificationsField(" . $jsonVars . ");");

        // Render the input template
        return Craft::$app->getView()->renderTemplate(
            'oakland-email-notifications/_components/fields/OaklandEmailTriggerField_input',
            [
                'name' => $this->handle,
                'value' => $value,
                'field' => $this,
