...
namespace modules\dateinputmodule;

use modules\dateinputmodule\assetbundles\dateinputmodule\DateInputModuleAsset;
use modules\dateinputmodule\twigextensions\DateInputModuleTwigExtension;
...
class DateInputModule extends Module
{
    ...
    {
        Craft::setAlias('@modules/dateinputmodule', $this->getBasePath());
        $this->controllerNamespace = 'modules\dateinputmodule\controllers';
        ...
        if (!isset($i18n->translations[$id]) && !isset($i18n->translations[$id.'*'])) {
            $i18n->translations[$id] = [
                ...
                'basePath' => '@modules/dateinputmodule/translations',
    ...
    public function init()
    {
        ...
        Craft::$app->view->registerTwigExtension(new DateInputModuleTwigExtension());
